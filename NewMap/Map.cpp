...
//{
//    
//    bool Map::Init(TCHAR* shaderfile, TCHAR* texturefile)
//    {
//        MapDesc md;
...
//    {
//    }
//    bool HeightMap::Init(TCHAR* shaderfile, TCHAR* texturefile,TCHAR* heightmapfile)
//    {
...
//        return true;
//    }
//    HRESULT HeightMap::CreateVertexBuffer() {
//        HRESULT hr = S_OK;
...
//
//      
//    DirectX::XMVECTOR HeightMap::ComputeFaceNormal(DWORD i0, DWORD i1, DWORD i2)
//    {
//        DirectX::XMVECTOR vNormal;
//        DirectX::XMVECTOR v0, v1, v2;
