...
// Tool_2Doc.cpp: CTool2Doc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CTool2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CTool2Doc::InitializeSearchContent()
{
...
void CTool2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
