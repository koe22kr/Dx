...
namespace DX
{
    ...
    struct PNCT_VERTEX
    {
        ...
        PNCT_VERTEX(D3DXVECTOR3 in_p, D3DXVECTOR3 in_n, D3DXVECTOR4 in_c, D3DXVECTOR2 in_t)
        {
            p.x = in_p.x;
            p.y = in_p.y;
            p.z = in_p.z;
    ...
    class CADevice_Helper : public CASingleton<CADevice_Helper>
    {
        friend CASingleton<CADevice_Helper>;
    public:
        HRESULT hr;
...
#define I_DXHELPER CADevice_Helper::GetInstance()