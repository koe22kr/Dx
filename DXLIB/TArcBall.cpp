...
namespace DX
{
    ...
    D3DXVECTOR3 TArcBall::ScreenToVector(float fScreenPtX, float fScreenPtY)
    {
    ...
    //--------------------------------------------------------------------------------------
    D3DXQUATERNION TArcBall::QuatFromBallPoints(const D3DXVECTOR3 &vFrom, const D3DXVECTOR3 &vTo)
    {
