...
namespace DX
{
    ...
    void CADx_Model2::SetCollisionData()
    {
        ...
        m_tBox.vMin = DirectX::XMFLOAT3(-1, -1, -1);
        m_tBox.vMax = DirectX::XMFLOAT3(1, 1, 1);

        m_tBox.vAxis[0] = DirectX::XMFLOAT3(1, 0, 0);
        m_tBox.vAxis[1] = DirectX::XMFLOAT3(0, 1, 0);
        m_tBox.vAxis[2] = DirectX::XMFLOAT3(0, 0, 1);
        m_tBox.fExtent[0] = 1.0f;
        m_tBox.fExtent[1] = 1.0f;
        m_tBox.fExtent[2] = 1.0f;
        m_tSphere.vCenter = m_tBox.vCenter;
        DirectX::XMFLOAT3 v;
