...
namespace DX
{
        ...
        ID3DBlob** ppBlobOut)
    {
        ...
        if (FAILED(hr = D3DX11CompileFromFile(
            ...
            dwShaderFlags, 0, NULL, ppBlobOut, &pErrorMsgs, NULL)))
        {
    ...
    bool CADx_Helper2::Render(ID3D11DeviceContext* pContext)
    {
