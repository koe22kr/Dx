...
void CATexture::Set_Start_Location(int draw_count, int vertex_location, int index_location)
{
...
bool CATexture::Draw(ID3D11DeviceContext* pContext)
{
    ...
    {
        pContext->DrawIndexed(m_Draw_Count, m_Start_Index_Location, m_Start_Vertex_Location);
    }
    else
    {
